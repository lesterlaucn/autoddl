...
import com.lesterlaucn.autoddl4j.JdbcBound;
...
public interface ITableSchema {
    ...
    Map<String, JdbcBound> jdbcTemplateMap = Maps.newHashMap();
     ...
     */
    public default void register(String packageName, JdbcBound tableSchemaBound) {
