...
官方文档：[ACTable官方文档地址](https://www.yuque.com/liuyuancheng/actable/nfz097)
...
[Javadoc文档：https://apidoc.gitee.com/liuyuancheng/mybatis-enhance](https://apidoc.gitee.com/liuyuancheng/mybatis-enhance)
...
```
    <dependency>
        <groupId>com.gitee.liuyuancheng.mybatis.actable</groupId>
...
```
    ...
    1. classpath*:com/gitee/liuyuancheng/mybatis/actable/mapping/*/*.xml
    2. com.gitee.liuyuancheng.mybatis.actable.dao.*
```

4. 扫描actable的包到spring容器中管理(必备的配置)

```
    1. com.gitee.liuyuancheng.mybatis.actable.manager.*
```
...
```
    ...
    mybatis.mapperLocations=classpath*:com/gitee/liuyuancheng/mybatis/actable/mapping/*/*.xml;自己的mapper.xml没有可不填
```

3. springboot启动类需要做如下配置

```
    1. 通过注解@ComponentScan配置，扫描actable要注册到spring的包路径"com.gitee.liuyuancheng.mybatis.actable.manager.*"
    2. 通过注解@MapperScan配置，扫描mybatis的mapper，路径为"com.gitee.liuyuancheng.mybatis.actable.dao.*"
```
...
```
    ...
    <context:component-scan base-package="com.gitee.liuyuancheng.mybatis.actable.manager.*" />
    ...
    <bean id="sqlSessionFactory" class="org.mybatis.spring.SqlSessionFactoryBean">
        ...
        <property name="mapperLocations">
            <array>
              ...
              <value>classpath*:com/gitee/liuyuancheng/mybatis/actable/mapping/*/*.xml</value>
            </array>
        </property>
    ...
    <bean class="org.mybatis.spring.mapper.MapperScannerConfigurer">
        <property name="basePackage" value="com.gitee.liuyuancheng.mybatis.actable.dao.*;自己的dao.*没有可不填" />
...
**代码用途讲解** 
    ...
    13.支持javax.persistence包中的部分注解，用于对tk.mybatis做支持
        ...
        javax.persistence.Column         同       com.gitee.liuyuancheng.mybatis.actable.annotation.Column
        javax.persistence.Column.name    同       com.gitee.liuyuancheng.mybatis.actable.annotation.Column.name
        javax.persistence.Column.length  同       com.gitee.liuyuancheng.mybatis.actable.annotation.Column.length
        javax.persistence.Column.scale   同       com.gitee.liuyuancheng.mybatis.actable.annotation.Column.decimalLength
        javax.persistence.Table          同       com.gitee.liuyuancheng.mybatis.actable.annotation.Table
        javax.persistence.Id             同       com.gitee.liuyuancheng.mybatis.actable.annotation.IsKey
 ...
 **AC.Table支持tk.mybatis框架的CUDR方法**
    ...
    import com.gitee.liuyuancheng.mybatis.actable.annotation.Index;
    import com.gitee.liuyuancheng.mybatis.actable.annotation.IsAutoIncrement;
    import com.gitee.liuyuancheng.mybatis.actable.annotation.IsKey;
...
37. 支持使用javax.persistence的Column/Table/Id等注解生成及更新表(版本1.3.0.RELEASE)
        ...
        javax.persistence.Column = com.gitee.liuyuancheng.mybatis.actable.annotation.Column
        javax.persistence.Column.name = com.gitee.liuyuancheng.mybatis.actable.annotation.Column.name
        javax.persistence.Column.length = com.gitee.liuyuancheng.mybatis.actable.annotation.Column.length
        javax.persistence.Column.scale = com.gitee.liuyuancheng.mybatis.actable.annotation.Column.decimalLength
        javax.persistence.Table = com.gitee.liuyuancheng.mybatis.actable.annotation.Table
        javax.persistence.Id = com.gitee.liuyuancheng.mybatis.actable.annotation.IsKey
